...
u16	adc_dat_min = 0xffff;
u16	adc_dat_max = 0;
#endif

#if (DBG_ADC_SAMPLE_DAT)
volatile int * adc_dat_buf;
volatile signed int adc_dat_raw[ADC_SAMPLE_NUM*128];
u8	adc_index = 0;
u16 avg_convert_raw = 0;
u16 avg_convert_oct = 0;
u16 adc_average = 0;
u16 voltage_mv_oct = 0;
...
//////////////// adc sample data convert to voltage(mv) ////////////////
	...
	// demo code
		...
		sleep_us(200000);
#else
		analog_write(0x3c, LOW_BATT_FLG);  //mark
