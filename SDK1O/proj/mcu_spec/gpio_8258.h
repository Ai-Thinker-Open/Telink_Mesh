...
typedef enum{
		...
		GPIO_PC1 = 0x200 | BIT(1),  /*GPIO_PWM0C1=GPIO_PC1,  GPIO_PWM1NC1=GPIO_PWM0C1,*/
		GPIO_PC2 = 0x200 | BIT(2),  GPIO_PWM0C2=GPIO_PC2,
		GPIO_PC3 = 0x200 | BIT(3),  GPIO_PWM1C3=GPIO_PC3,  GPIO_URXC3=GPIO_PC3,
		GPIO_PC4 = 0x200 | BIT(4),  /*GPIO_PWM2C4=GPIO_PC4,  GPIO_PWM0NC4=GPIO_PWM2C4,*/
		...
		GPIO_PD5 = 0x300 | BIT(5),  /*GPIO_PWM0D5=GPIO_PD5,  GPIO_PWM0ND5=GPIO_PWM0D5,*/
