...
#define LPN_DEBUG_PIN_EN        0           // if use 8258 dongle to debug, this must enable to cancle gpio wakeup
...
#define GPIO_VBAT_DETECT				GPIO_PB3
#define PB7_FUNC						AS_GPIO
#define PB7_INPUT_ENABLE				0
#define ADC_INPUT_PCHN					B3P    //corresponding  ADC_InputPchTypeDef in adc.h
#endif
